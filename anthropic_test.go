...
func TestClaudeAdapterScenarios(t *testing.T) {
	t.Run("AnthropicErrorClassification", func(t *testing.T) { testAnthropicErrorClassification(t) })
	t.Run("AnthropicGenerateReturnsContentPolicyErrorForRefusal", func(t *testing.T) { testAnthropicGenerateReturnsContentPolicyErrorForRefusal(t) })
	t.Run("AnthropicGeneratorStreamRetriesOverloadedSSEError", func(t *testing.T) { testAnthropicGeneratorStreamRetriesOverloadedSSEError(t) })
	t.Run("AnthropicGenerator/Count", func(t *testing.T) {
	...
	t.Run("AnthropicGenerator/Count/IncludesTools", func(t *testing.T) { testAnthropicGenerator_Count_IncludesTools(t) })
	t.Run("AnthropicGenerator/Generate", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
	...
	t.Run("AnthropicGenerator/Generate/image", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
	...
	t.Run("AnthropicGenerator/Generate/pdf", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
	...
	t.Run("AnthropicGenerator/Generate/thinking", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
		// Instantiate an Anthropic Generator
	...
	t.Run("AnthropicGenerator/RequestTools", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
...
`
	...
	t.Run("AnthropicGenerator/RequestTools/parallelToolUse", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
		// Define request tools
	...
	t.Run("AnthropicGenerator/Stream", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
		// Demonstration of how to enable system prompt caching
	...
	t.Run("AnthropicGenerator/Stream/parallelToolUse", func(t *testing.T) {
		requireLiveAPIKey(t, "ANTHROPIC_API_KEY")
		// Create an Anthropic client
		client := a.NewClient()
		// Define request tools
	...
	t.Run("AnthropicStreamReturnsContentPolicyErrorForRefusal", func(t *testing.T) { testAnthropicStreamReturnsContentPolicyErrorForRefusal(t) })
}
