...
func TestDeepSeekAdapterScenarios(t *testing.T) {
	t.Run("DeepSeekBuildRequestReplaysThinking", func(t *testing.T) {
	...
	t.Run("DeepSeekGeneratorLive", func(t *testing.T) {
	...
	t.Run("DeepSeekGeneratorMapsGeneratedError", func(t *testing.T) {
	...
	t.Run("DeepSeekGeneratorUsesGeneratedJSONClient", func(t *testing.T) {
	...
	t.Run("DeepSeekGeneratorUsesGeneratedSSEClient", func(t *testing.T) {
		server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			var request map[string]any
