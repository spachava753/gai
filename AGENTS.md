...
- Root Go module (go.mod) with all library code colocated for ease of import
  ...
  - Generated OpenAPI clients: `internal/openai/` uses oapi-codegen; `internal/openrouter/` uses OGEN. Cerebras, DeepSeek, and Z.AI use the shared OpenAI client; their unused generated clients have been removed.
...
- Lint: `go tool laas -exclude-packages='^github\.com/spachava753/gai/internal/(openai|openrouter)$' ./...`
